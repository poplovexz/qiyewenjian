  ...
  <div class="reimbursement-form-container">
    ...
    <van-form @submit="onSubmit">
      ...
      <van-cell-group inset title="基本信息">
        <van-field
          v-model="formData.baoxiao_leixing_text"
          label="报销类型"
          placeholder="请选择报销类型"
          readonly
          required
          right-icon="arrow"
          @click="showReimbursementTypePicker = true"
        />

        <!-- 报销金额 -->
        <van-field
          v-model="formData.baoxiao_jine"
          label="报销金额"
          type="number"
          placeholder="请输入报销金额"
          required
        ...
        <!-- 报销时间 -->
        <van-field
          v-model="formData.baoxiao_shijian_text"
          label="报销时间"
          placeholder="请选择报销时间"
          readonly
          required
      ...
      <van-cell-group inset title="报销原因">
        <van-field
          v-model="formData.baoxiao_yuanyin"
          type="textarea"
          placeholder="请输入报销原因"
          rows="4"
          maxlength="500"
    ...
    <!-- 报销类型选择器 -->
    <van-popup v-model:show="showReimbursementTypePicker" position="bottom">
      <van-picker
        :columns="reimbursementTypeOptions"
        @confirm="onReimbursementTypeConfirm"
        @cancel="showReimbursementTypePicker = false"
      />
    </van-popup>
