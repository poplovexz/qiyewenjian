...
async function configureAlipaySandbox() {
  try {
    ...
    const response = await fetch(
      "http://localhost:8000/api/v1/payment-configs/",
      {
        method: "POST",
        headers: {
